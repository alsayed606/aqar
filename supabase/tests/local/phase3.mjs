// Office behavioural + isolation tests against a real PG17 (Charter هـ-36/37).
// Covers: viewer read-only enforcement (0033), portal identity-isolation (0028/0029), core
// financial ops (0019), contract renewal (0031), and the subscription/billing engine an office
// sees (0036-0044). Complements verify.mjs (data layer) and platform.mjs (the super-admin console,
// which boots its own database and seeds only what it asserts on).
