...
export async function middleware(request: NextRequest) {
  ...
  if (isProtected && user && pathname !== "/auth/mfa") {
    ...
    // Our own state (0069/0070) is read whenever it can change the answer, which — since recovery
    ...
    // The restricted session (migration 0070): an e-mail code was accepted in place of an
