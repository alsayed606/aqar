...
// ---------------------------------------------------------------------------
// Recovery, exit one: a code off the sheet the user printed at enrolment (migration 0070).
// ---------------------------------------------------------------------------
...
// codes. Weaker than the factor it bypasses, so it opens a RESTRICTED session (see 0070).
// ---------------------------------------------------------------------------
