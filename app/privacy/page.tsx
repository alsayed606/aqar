...
export default function PrivacyPage() {
  return (
    <LegalShell title="سياسة الخصوصية" updated="٢٨ يوليو ٢٠٢٦">
      ...
      <H>٥. حقوقك وكيف تمارسها</H>
      <ul>
        <li>
          <b>الوصول والنقل:</b> نزّل نسخة كاملة من بيانات منشأتك بصيغة <span dir="ltr">JSON</span> في أي وقت من
          <b> الإدارة ← الخصوصية والبيانات</b>.
        </li>
        <li>
          <b>التصحيح:</b> عدّل بياناتك مباشرة من صفحاتها داخل النظام.
        </li>
        <li>
          <b>الحذف:</b> اطلب حذف حساب منشأتك من الصفحة نفسها. يُنفَّذ الحذف نهائياً بعد <b>٣٠ يوماً</b>، ويمكنك التراجع
          خلالها.
        </li>
        <li>
          <b>حذف بيانات مستأجر أو مالك:</b> منشأتك هي المتحكّم في بيانات عملائها ونحن المعالج لها، فيُنفَّذ الطلب من
          صفحة الشخص داخل حساب المنشأة.
        </li>
      </ul>

      <H>٦. الاحتفاظ بالبيانات — وما لا يُحذف</H>
      <p>
        نحتفظ ببياناتك طوال فترة اشتراكك. وبعد الحذف يبقى ما تُلزمنا الأنظمة بحفظه فقط:
      </p>
      <ul>
        <li>
          <b>الفواتير الضريبية</b> التي أصدرتها منشأتك — تُلزم أنظمة الزكاة والضريبة والجمارك بحفظها، وحذفها يعرّض
          منشأتك للمخالفة. لذلك يُحذف الاسم والهوية ووسائل التواصل، وتبقى الفاتورة كما صدرت.
        </li>
        <li>
          <b>سجلّ مدفوعات اشتراكك في «عقار»</b> — وهو سجلّ مبيعاتنا نحن، وتلزمنا الأنظمة الضريبية بحفظه بعد إغلاق
          حسابك.
        </li>
      </ul>
      <p>ما عدا ذلك يُحذف نهائياً ولا يمكن استرجاعه.</p>
