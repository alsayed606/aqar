...
// returnTo is the validated, app-internal path to land on after a successful login (default /app).
// It rides as a hidden field in both steps so it survives the phone → code transition.
